...
<img width="1338" height="404" alt="image" src="https://github.com/user-attachments/assets/51ddadf7-7154-483d-bfa2-e988f6d786fa" />
- 사고의 흐름대로 코드가 적혀있어 이해하기 쉽다.
...
```
# 리뷰어의 회고를 작성합니다.
내가 메소드 사용방법을 숙지하면 좋을 것 같다..
코드에 남도 이해하기 쉽게 주석을 많이 달아야겠다..

# 코드 리뷰 시 참고한 링크가 있다면 링크와 간략한 설명을 첨부합니다.
링크 없음..
# 코드 리뷰를 통해 개선한 코드가 있다면 코드와 간략한 설명을 첨부합니다.
회문판독기에서 글자를 뒤집을 수 있는 함수 reversed()로 변경
